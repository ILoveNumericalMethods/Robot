...
const int PIN_R_IN_1 = 1;
const int PIN_R_IN_2 = 1;
const int PIN_L_IN_1 = 1;
const int PIN_L_IN_2 = 1;
const int PIN_R_PWD = 1;
const int PIN_L_PWD = 1;



const int PIN_STBY = 9;
